RSpec.describe 'max_by' do
  ...
  it 'array with the most items' do
    ...
    biggest_array = arrays.max_by do |arr|
      arr.length
    end
  ...
  it 'array with fewest items' do
    ...
    smallest_array = arrays.max_by do |arr|
      -arr.length
    end
  ...
  it 'most programmers' do
    ...
    most_programmers = programmers.max_by do |lang, peeps|
      peeps.length
    end
  ...
  it 'fewest programmers' do
    ...
    fewest_programmers = programmers.max_by do |lang, peeps|
      -peeps.length
    end
